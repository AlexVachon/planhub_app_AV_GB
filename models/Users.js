...
const UserModel = new mongoose.Schema({
    first_name: {
        ...
        validate: {
            ...
            message: "Le prénom doit contenir uniquement des lettres (entre 3 et 50 caractères)."
        }
    },
    last_name: {
        type: String,
        ...
        valida: {
            ...
            message: "Le nom doit contenir uniquement des lettres (entre 3 et 50 caractères)."
        }
    },
    username: {
        type: String,
        ...
        validate: [{
            validator: async function (v) {
                const existingUsername = await this.constructor.findOne({ username: v })
